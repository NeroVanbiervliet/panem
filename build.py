...
# auxiliary function
def replaceCodeInFileRegex(filePath, regex, newText):
	# read file 
	lines = tuple(open(filePath, "r"))

	with open(filePath, "w") as f:
		for line in lines: 
			line = re.sub(regex,newText,line)
			f.write(line)
...
replaceCodeInFile(distPath + 'email_templates/forgotpassword.html', '<a href="http://localhost/#/','<a href="http://'+serverIp+'/#/')
replaceCodeInFile(distPath + 'email_templates/forgotpassword.html', 'http://localhost/images/','http://'+serverIp+'/images/')
